Midterm Lab Exam
Course: Mobile Application Development 1305216 Mobile Application Development Score: 10% Raw score
...
Write a Product Requirement Spec
Use AI tools if needed to help build the system
System Features
...
GPS Location
Timestamp
Scan the class QR Code or other solutions
...
Save data
Part 3 — Data Storage
The system must be able to store check-in and check-out data. - Use localStorage or SQLite for MVP version
...
Example: AI was used to generate Flutter UI scaffolding and QR scanner integration. I modified the form validation and Firebase data structure manually.

Suggested Time Allocation
Task	Time
Requirement Analysis + PRS | 30 min | Flutter Development | 90 min | Firebase Integration | 30 min | Deployment + README | 30 min |
